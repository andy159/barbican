// Generates the Conservatory level (336x60) and writes levels/conservatory.js.
...
// west flank, a roof walk, and the Arid House (cacti) descending to the exit.
...
set(330,335,42,42,'='); set(330,335,43,59,'#');
set(334,335,40,41,'E');                      // the way out
